...
const { uploadContent, getContent, deleteContent, getExplore, getHome , uploadSlider } = require("../controllers/ContentController");
...
router.post("/slider-upload", upload.single("file"), s);
