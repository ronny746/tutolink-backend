...
const { uploadQuiz, createQuizForBattle, getQuizzes, updateQuiz, getallQuizzes, deleteQuiz, getQuizById, submitQuiz, getQuizReview, deleteUserTakenQuiz, quizResult } = require("../controllers/quizController");
...
router.get("/reviegw/:quizId", verifyToken, getQuizReview);
