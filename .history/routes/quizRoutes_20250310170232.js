...
const { uploadQuiz, getQuizzes, updateQuiz, getallQuizzes, deleteQuiz, getQuizById, submitQuiz, getQuizReview, deleteUserTakenQuiz, quizResult } = require("../controllers/quizController");
...
router.get("/quizResult/:quizId", verifyToken, getQuizReview);
