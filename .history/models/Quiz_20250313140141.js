...
const QuizSchema = new mongoose.Schema({
  ...
  startTime: { type: String, default: new Date().toISOString() }, // Default: abhi ka time
  endTime: { type: String, default: new Date(Date.now() + 86400000).toISOString() }, // Default: next day
  status: { type: String, enum: ["Upcoming", "Live", "Ended"], default: "Upcoming" } ,// Default status
