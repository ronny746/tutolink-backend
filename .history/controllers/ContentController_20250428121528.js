...
exports.getHome = async (req, res) => {
  try {
    ...
    const battles = await Battle.find()
      .populate("quizId", "name") // Populate quizId for quiz name (optional)
      .populate("createdBy", "username email") // Populate creator's user details (optional)
      .populate("participants", "username email") // Populate participants' user details (optional)
      .populate("winner", "username email") // Populate winner's user details (optional)
      .populate("winners", "username email") // Populate multiple winners' user details (optional)
      .populate("scores.userId", "username email"); // Populate user info in scores (optional)
