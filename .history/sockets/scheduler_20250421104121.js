...
const Battle = require("../models/q");
const sendNotification = require("../utils/sendNotification"); // Your FCM/OneSignal logic
      ...
      for (const user of battle.participants) {
        if (user.deviceToken) {
          await sendNotification({
            ...
            body: `Your quiz battle is starting in 5 minutes. Battle Code: ${battle.battleCode}`,
          });
        }
      }
    }
