...
const { uploadQuiz, getQuizzes, updateQuiz, getallQuizzes, deleteQuiz, getQuizById, submitQuiz, getQuizReview,deleteUserTakenQuiz } = require("../controllers/quizController");
