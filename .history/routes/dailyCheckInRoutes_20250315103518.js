...
const { dailyCheckIn, getUserCheckInHistory,getUserMissedCheckin } = require("../controllers/dailyCheckInController");
...
router.get("/userMissedHistory", verifyToken, getUserCheckInHistory);
