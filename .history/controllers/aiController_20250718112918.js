...
const allModels = [
    { model: User, label: "User Data", priority: 2 },
  { model: Note, label: "Notes", priority: 2 },
  { model: Courses, label: "Course Syllabus", priority: 2 },
  { model: Question, label: "Chapter Questions", priority: 3 },
  { model: Subject, label: "Subject Information", priority: 4 },
  { model: Quiz, label: "Quiz Topics", priority: 5 },
