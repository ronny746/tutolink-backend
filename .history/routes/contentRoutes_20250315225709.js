...
const { uploadContent, getContent, deleteContent, getExplore, getHome , uploadSlider,o } = require("../controllers/ContentController");
...
router.post("/getHome", verifyToken, getHome);
