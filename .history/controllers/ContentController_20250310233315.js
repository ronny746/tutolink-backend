...
exports.getHome = async (req, res) => {
  try {
    ...
    // ✅ Fetch top 3 users with highest score
    const topUsers = await User.find({}, "name points profilePic")
      .sort({ score: -1 }) // Highest score first
      .limit(3);

    // ✅ Dummy trending topics (Modify as needed)
    const trendingTopics = ["Physics", "Chemistry", "Biology"];
